...
__posh_git_echo () {
    ...
    local BeforeText=' '
    local BeforeForegroundColor=$(__posh_color '\e[m') # Yellow
    local BeforeBackgroundColor=
    local DelimText=' |'
    local DelimForegroundColor=$(__posh_color '\e[m') # Yellow
    local DelimBackgroundColor=

    local AfterText=''
    local AfterForegroundColor=$(__posh_color '\e[m') # Yellow
